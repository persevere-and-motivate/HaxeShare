package php;
#if !php
#error "You must target PHP to access the php.EGlobal class."
#end
...
extern class EGlobal
{
    ...
    **/
    public static final OAUTH_BAD_TIMESTAMP:Int;
    ...
    **/
    public static final OAUTH_TOKEN_REJECTED:Int;

    /**
    * The oauth_verifier is incorrect.
    **/
    public static final OAUTH_VERIFIER_INVALID:Int;
    ...
    **/
    public static final OAUTH_PARAMETER_ABSENT:Int;

    /**
    * The oauth_signature_method was not accepted by service provider.
    **/
    public static final OAUTH_SIGNATURE_METHOD_REJECTED:Int;
